...
#Tried fixing what the time looks like 
```{r}
...
```
##The maximum difference between open date and send date is only 8 days. Therefore, open date is not a factor to consider in my analysis. 
